...
public class MainView {
    ...
    public void loadExample1(IController controller){
        ...
        PrgState current= new PrgState(exestack,symTable,output, ex1,fileTable,heap);
    ...
    public void loadExample2(IController controller){
        ...
        FileTable fileTable=new MapFileTable();
        IHeap<Value> heap=new MyHeap<>();
        PrgState current= new PrgState(exestack,symTable,output, ex2,fileTable,heap);
    ...
    public void loadExample3(IController controller){
        ...
        FileTable fileTable=new MapFileTable();
        IHeap<Value> heap=new MyHeap<>();
        PrgState current= new PrgState(exestack,symTable,output, ex3,fileTable,heap);
    ...
    public void loadExample4(IController controller){
        ...
        FileTable fileTable=new MapFileTable();
        IHeap<Value> heap=new MyHeap<>();
        PrgState current= new PrgState(exestack,symTable,output, finalExample,fileTable,heap);
